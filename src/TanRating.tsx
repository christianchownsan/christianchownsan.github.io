...
export function TanRating() {
  ...
  return (
    <div className="tan-rating">
      <h1 className="tan-rating__title">
        Please fill out the answers below and hit submit - all submissions are
        completely anonymous.
      </h1>
      <section
        className={`tan-rating__questions${
          disabled ? " tan-rating__questions--submitted" : ""
        }`}
      >
        {questions.map((question, q) => (
          <div className="tan-rating__question question" key={question}>
      ...
      {submitted && (
        <p className="tan-rating__submitted">
